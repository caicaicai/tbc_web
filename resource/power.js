...
var Icon = {
	...
	setTexture: function (d, c, b) {
		...
		if (b.indexOf("?") != -1) {
			...
			a.backgroundImage = "url(https://db.excalibur.ws/images/icons/" + Icon.sizes[c] + "/" + b.toLowerCase() + ".jpg)"
		}
...
var Tooltip = {
	...
	setIcon: function (a) {
		Tooltip.prepare();
		if (a) {
			Tooltip.icon.style.backgroundImage = "url(https://db.excalibur.ws/images/icons/medium/" + a.toLowerCase() + ".jpg)";
...
function () {
	...
	function b(W, S, X, Q, T) {
		 ...
		 * "=" + S + "&power" + R;
		 */
		var P = "https://db.excalibur.ws/ajax.php?" + p[W][1] + "=" + S + "&power" + R;
		g_ajaxIshRequest(P)
	}
	function N(R, S) {
		if (J._fixTooltip) {
	...
	_link.href = "https://db.excalibur.ws/templates/wowhead/css/power.css?v110";
	_script.setAttribute("src","https://db.excalibur.ws/templates/wowhead/js/locale_enus.js");
